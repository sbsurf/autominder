  ...
  describe "GET #index" do
    ...
    describe "returns array of makes" do
      it "filters by year" do
        expect(edmunds).to receive(:find_makes_by_model_year).with('2015').and_return([{id: 200002038, models: []}, {id: 200464140, models: []}])
      ...
      it "returns all" do
        # allow(Edmunds::Make).to receive(:new).and_return(edmunds)
        expect(edmunds).to receive(:find_all).and_return([{id: 200002038, models: []}, {id: 200464140, models: []}, {id: 200000001, models: []}])
        # TODO: replace with factories
